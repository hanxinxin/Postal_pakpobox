...
@interface PostmanNextViewController ()<UITextFieldDelegate,UIGestureRecognizerDelegate>

@end

@implementation PostmanNextViewController
...
- (void) keyboardWillShow:(NSNotification *)notification {
    ...
    CGFloat offset = (self.NextBtn.top+self.NextBtn.height+kbHeight) - (SCREEN_HEIGHT);
...
- (IBAction)NextTouch:(id)sender {
    ...
    for (UIViewController *controller in self.navigationController.viewControllers) {
        if ([controller isKindOfClass:[PostmanViewController class]]) {
            [self.navigationController popViewControllerAnimated:YES];
