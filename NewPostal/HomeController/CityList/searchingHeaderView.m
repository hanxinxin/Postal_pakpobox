...
//        _titleLabel.textColor =[UIColor colorWithRed:20/255.0 green:146/255.0 blue:230/255.0 alpha:1.0];
        _titleLabel.textColor = SCGetColor(194, 194, 194, 1);
...
//        UIColor *textColor = SCGetColor(59, 60, 60, 1);[UIColor colorWithRed:194/255.0 green:194/255.0 blue:194/255.0 alpha:1.0]
        UIColor *textColor = SCGetColor(194, 194, 194, 1);
        UIColor *selectBgColor = [UIColor whiteColor];
        UIColor *bgColor = SCGetColor(241, 241, 241, 1);
...
//    self.contentView.backgroundColor = bgColor;
    self.contentView.backgroundColor = [UIColor colorWithRed:241/255.0 green:241/255.0 blue:241/255.0 alpha:1.0];
}
